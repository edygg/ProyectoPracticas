...
class PeriodoAcademicoController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('PeriodoAcademico');
	...
	{
		$model=new PeriodoAcademico('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PeriodoAcademico']))
			$model->attributes=$_GET['PeriodoAcademico'];
	 ...
	 * @param PeriodoAcademico $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='periodo-academico-form')
		{
