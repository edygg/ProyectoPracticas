...
class TipoCarreraController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('TipoCarrera');
	...
	{
		$model=new TipoCarrera('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TipoCarrera']))
			$model->attributes=$_GET['TipoCarrera'];
	 ...
	 * @param TipoCarrera $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-carrera-form')
		{
