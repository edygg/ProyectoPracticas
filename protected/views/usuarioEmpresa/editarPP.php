 ...
 <!--Profile Body-->
    ...
    'action' =>  Yii::app()->createUrl("/UsuarioEmpresa/ActualizarPracticaProfesional"), 
    ...
    'enableAjaxValidation'=>false,
                    ...
                    <header>Solicitud de Práctica Profesional</header>
                      <?php echo $form->hiddenField($practicaProfesional,'IdPracticaProfesional',array('type'=>"text" ,'name'=>"IdPracticaProfesional")); ?>   
                        ...
                        <div class="row">
                            ...
                            <section class="col col-4">             
                              ...
                              <section class="col col-4">             
                                ...
                                <label class="toggle"><?php echo $form->checkBox($practicaProfesional,'HorarioFlexible',array('name'=>"HorarioFlexible")); ?><i class="rounded-4x"></i>Requerie Promedio</label>
