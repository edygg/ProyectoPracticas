...
$this->pageTitle=Yii::app()->name . ' - Login Empresa';
    ...
    <div class="breadcrumbs">
        <div class="container">
            ...
            <ul class="pull-right breadcrumb">
                ...
                <li class="active">Login Empresa</li>
            </ul>
        </div><!--/container-->
    </div><!--/breadcrumbs-->
    <!--=== End Breadcrumbs ===-->
    ...
    'clientOptions'=>array(
        'validateOnSubmit'=>true,
                    ...
                    <div class="input-group margin-bottom-20">
                        ...
                        <?php echo $form->textField($model,'username',array('class'=>"form-control",'placeholder'=>"Email",'size'=>60,'maxlength'=>500)); ?>
