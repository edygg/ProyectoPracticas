...
<?php echo CHtml::beginForm(); ?>
                    ...
                    <div class="content-boxes-v3 block-grid-v1  bg-grey rounded">
                        <!-- <img class="rounded-x pull-left block-grid-v1-img" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/img/testimonials/img2.jpg" alt=""> -->
                        ...
                        <div class="content-boxes-in-v3 ">
                            <h3>
                                <?php $Cargo = substr($practica->practica->PuestoDesempeniar ,0,21) . "..." ;?>
                                 ...
                                 <?php  echo CHtml::link($Cargo ,array('UsuarioEstudiante/detallePractica',  'Cor'=>$practica->practica->IdPracticaProfesional));?>
                            ...
                            $text = '<i class="fa fa-eye"></i> Agregar', 
                            $url = array('UsuarioEstudiante/AgregarPracticaAEscritorio'), 
                            $ajaxOptions=array (
                                'type'=>'POST',
                                'data'=> array('idPractica'=>$practica->practica->IdPracticaProfesional),
                                ), 
                            $htmlOptions=array ()
                            ); ?></li>  
