...
<div class="wrapper">
        ...
        <div class="topbar">
            <div class="container">
                ...
                <ul class="loginbar pull-right">
                    ...
                    <li><a href="page_faq.html">Acceso a Empresas</a></li>  
                    <li class="topbar-devider"></li>   
                    <li><a href="page_login.html">Acceso a Estudiantes</a></li>   
                </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 animated fadeInLeft">
                    <span>Gestor y Buscador de Proyectos y Practicas Profesionales</span>
                    <p> Plataforma web capaz de gestionar, almacenar y mostrar de manera amigable el portafolio de opciones de proyectos de graduación  y empresas donde alumnos puedan desarrollar su practica profesional. </p>
                </div>            
    ...
    <div class="container content">	
        ...
        <div id="clients-flexslider" class="flexslider home clients">
            <div class="headline"><h2>Empresas Participantes</h2></div>    
            <ul class="slides">
                <li>
                    <a href="#">
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/js/plugins/parallax-slider.js"></script>
