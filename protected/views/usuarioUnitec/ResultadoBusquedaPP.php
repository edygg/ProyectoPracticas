                        ...
                        <div class="content-boxes-in-v3 ">
                            <h3>
                                <?php $Cargo = substr($practica->practica->PuestoDesempeniar ,0,21) . "..." ;?>
                                 ...
                                 <?php  echo CHtml::link($Cargo ,array('UsuarioUnitec/detallePractica',  'Cor'=>$practica->practica->IdPracticaProfesional));?>
                            ...
                            <ul class="list-inline block-grid-v1-add  pull-right ">
                                <li><a href="#"><i class="fa fa-retweet"></i>Compartir</a></li>
