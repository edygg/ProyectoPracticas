...
<div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="home-1">
                             <?php $form=$this->beginWidget('CActiveForm', array(
                                ...
                                <header>Registro de Asesoramiento  -  <?php echo ucwords(strtolower(UsuarioEstudiante::model()->findbyPk($model->UsuarioEstudiante_IdUsuarioEstudiante)->NombreCompleto))   ?></header>
                       ...
                       <div class="table-search-v2 margin-bottom-20">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                    ...
                                    <?php echo CHtml::image(Yii::app()->request->baseUrl.'/banner/'.$practica->asesor->Imagen,"image",array("class"=>'rounded-x')); ?>
                                     ...
                                     <?php endif ?>  
                                        ...
                                        <?php if ( $practica->asesor->DescripcionPersonal == "")  : ?>
                                            <p>Hola chicos! Es un placer poder ser su jefe indmediato en <?php echo ucwords(strtolower($practica->asesor->usuarioEmpresa->NombreEmpresa)  );?>, recuerden que cualquier cosa estoy  a sus ordenes.</p>
                                            <?php endif; ?>
                                ...
                                <footer>
                                    <?php echo CHtml::link('Volver',array('UsuarioUnitec/MisAlumnos','Seccion'=>$_GET['curso']), array('class'=>'btn-u btn-u-default')); ?>
                                    <button type="submit" class="btn-u">Guardar Asesoramiento</button>
